        ...
        <div class="offcanvas-content pr-5 mr-n5">
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-danger">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/پرونده ها/ انتخاب شده -file.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div>
                ...
                <div class="d-flex align-items-center bg-light-success rounded p-5 gutter-b">
                    ...
                    <div class="d-flex flex-column flex-grow-1 mr-2">
                        <a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">برای
                            مردم خواهد بود</a>
                        <span class="text-muted font-size-sm">موعد 2 روز</span>
                    </div>
                ...
                <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                    ...
                    <div class="mb-15">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">نویسندگان
                                    برتر</a>
                                <span class="text-muted font-weight-bold">موفق ترین ها</span>
                            </div>
                            <span
                                class="btn btn-sm btn-light font-weight-bolder py-1 my-lg-0 my-2 text-dark-50">+82دلار</span>
                        </div>
                        <!--end: Item-->
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            ...
                            <span
                                class="btn btn-sm btn-light font-weight-bolder  my-lg-0 my-2 py-1 text-dark-50">+280دلار</span>
                        </div>
                        <!--end: Item-->
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">کاربران
                                    جدید</a>
                                <span class="text-muted font-weight-bold">موفق ترین ها</span>
                            </div>
                            <span
                                class="btn btn-sm btn-light font-weight-bolder  my-lg-0 my-2 py-1 text-dark-50">+4500دلار</span>
                        </div>
                        <!--end: Item-->
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">فعال
                                    مشتریان</a>
                                <span class="text-muted font-weight-bold">موفق ترین ها</span>
                            </div>
                            <span
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">تم
                                    پرفروش</a>
                                <span class="text-muted font-weight-bold">موفق ترین ها</span>
                            </div>
                            <span
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">اهداف
                                    دیگر</a>
                                <span class="text-muted font-size-sm">موعد 2 روز</span>
                            </div>
                        ...
                        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">برای
                                    مردم خواهد بود</a>
                                <span class="text-muted font-size-sm">موعد 2 روز</span>
                            </div>
                        ...
                        <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">هدف این
                                    خواهد بود که ترغیب شود</a>
                                <span class="text-muted font-size-sm">موعد 2 روز</span>
                            </div>
                        ...
                        <div class="d-flex align-items-center bg-light-info rounded p-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="#"
                                    class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">بهترین
                                    محصول</a>
                                <span class="text-muted font-size-sm">موعد 2 روز</span>
                            </div>
                            ...
                            <div class="messages">
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#"
                                                class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">محسن
                                                برومند</a>
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    ...
                                    <div
                                        class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">
                                        شما می توانید با کلیک بر روی این مخزن بلافاصله از حالت انتخاب خارج شوید:<a
