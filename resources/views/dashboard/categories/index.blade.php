                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <x-dashboard.pages.partials.data-table
                                :iterator="$categories"
                                :isPaginated="$dataTableInformation['isPaginated']"
                                :columns="$dataTableInformation['columns']"
                                :objectColumnNames="$dataTableInformation['objectColumnNames']"
                                :tableColumnsCount="$dataTableInformation['tableColumnsCount']"
                            >
